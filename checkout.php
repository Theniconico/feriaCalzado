        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="border p-4 rounded" role="alert">
              Ya eras cliente? <a href="#">Click aquí</a> Para ingresar
            </div>
          </div>
        </div>
        <!-- formulario registro-->
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group">
                ...
                <div class="collapse" id="create_an_account">
                  <div class="py-2">
                    <p class="mb-3">Crea tu cuenta rellenando el siguiente formulario </p>
                    <div class="form-group">
              ...
              <div class="form-group">
                <label for="c_order_notes" class="text-black">Comentarios adicionales</label>
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <label for="c_code" class="text-black mb-3">Ingresa tu código de descuento si tienes uno ;)</label>
              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="border p-3 mb-3">
                    <h3 class="h6 mb-0"><a class="d-block" data-toggle="collapse" href="#collapsebank" role="button" aria-expanded="false" aria-controls="collapsebank">Transferencia directa a banco</a></h3>

                    <div class="collapse" id="collapsebank">
                      <div class="py-2">
                        <p class="mb-0">Envianos tu pago a nuestra cuenta bancaria, luego adjunta tu comprobante de pago para hacer efectiva la compra.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary btn-lg py-3 btn-block" type="submit">Haz tu orden !</button>
                  </div>
